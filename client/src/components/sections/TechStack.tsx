  ...
  return (
    <section id="techstack" className="py-32 relative overflow-hidden bg-[#060608]">
      <div className="container mx-auto px-6 md:px-20 relative z-10">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-24 border-b-2 border-primary/20 pb-12 gap-12 relative overflow-hidden">
           ...
           <div>
            <div className="flex items-center gap-3 mb-6">
              ...
              <span className="text-[10px] font-mono text-primary uppercase tracking-[0.5em] font-bold animate-flicker">Asset_Dependency_Map</span>
            </div>
          ...
          <div className="flex gap-16 text-[10px] font-mono text-white/30 uppercase tracking-[0.2em]">
            ...
            >
              ...
              <div className="flex items-center justify-between mb-12">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h3 className="text-sm font-black font-mono tracking-[0.2em] text-white uppercase italic">{cat.label}</h3>
                    <span className="text-[8px] font-mono text-white/20 uppercase tracking-widest">{cat.specs}</span>
                  </div>
                </div>
              ...
              <div className="mt-auto flex flex-col gap-6 pt-8 border-t border-white/5">
                <div className="flex justify-between items-end">
                  <div className="flex flex-col gap-2">
                    <span className="text-[8px] font-mono text-white/20 uppercase tracking-[0.2em]">Compute_Cycle_Utilization</span>
        ...
        {/* Modular Footnote */}
        <div className="mt-20 flex flex-col md:flex-row justify-between items-center gap-10 px-10 py-8 bg-primary/5 border border-primary/20 relative">
          <div className="absolute top-0 left-10 w-10 h-1 bg-primary" />
          <div className="flex items-center gap-12 text-[10px] font-mono text-white/40 uppercase">
          ...
          <div className="flex items-center gap-4">
            <span className="text-[11px] font-mono font-black text-primary tracking-[0.5em] uppercase">Engineering_Integrity_Verified</span>
